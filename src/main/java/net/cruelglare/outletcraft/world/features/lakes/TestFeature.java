...
package net.cruelglare.outletcraft.world.features.lakes;
...
public class TestFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("outletcraft:test", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(OutletcraftModBlocks.TEST.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("outletcraft:test", CONFIGURED_FEATURE,
